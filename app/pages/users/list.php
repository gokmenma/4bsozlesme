                    ...
                    <?php foreach ($users as $u): ?>
                        <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 transition-colors">
                            <td class="font-medium text-zinc-900 dark:text-zinc-100">
                                <div class="flex items-center gap-3">
                                    <span class="flex size-8 shrink-0 items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs font-semibold border border-indigo-100 dark:border-indigo-800">
                                        <?php 
...
<dialog id="dialog-add-user" class="dialog w-full sm:max-w-[450px]" onclick="if (event.target === this) this.close()">
    ...
    <form action="<?php echo routeUrl('kullanici-ekle'); ?>" method="POST" id="form-add-user" class="form grid gap-4">
        ...
        <div class="grid gap-2">
            ...
            <div id="select-role-add" class="app-select w-full">
              <button type="button" class="btn-outline w-full justify-between" id="select-role-add-trigger" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-role-add-listbox">
              ...
              <div id="select-role-add-popover" data-popover data-custom-popover aria-hidden="true" class="w-full">
                <div role="listbox" id="select-role-add-listbox" class="p-1">
                    <div role="option" data-value="user" class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded cursor-pointer text-sm flex items-center justify-between">
                        <span>User</span>
                    </div>
                    <div role="option" data-value="admin" class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded cursor-pointer text-sm flex items-center justify-between">
                        <span>Admin</span>
                    </div>
                    <?php if ($isSuperAdmin): ?>
                    <div role="option" data-value="superadmin" class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded cursor-pointer text-sm flex items-center justify-between">
...
<dialog id="dialog-edit-user" class="dialog w-full sm:max-w-[450px]" onclick="if (event.target === this) this.close()">
  <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-2xl" onclick="event.stopPropagation()">
    <header class="mb-6">
    ...
    <form id="form-edit-user" class="form grid gap-4">
        ...
        <div class="grid gap-2">
            ...
            <div id="select-role-edit" class="app-select w-full">
              <button type="button" class="btn-outline w-full justify-between" id="select-role-edit-trigger" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-role-edit-listbox">
                <span class="truncate">User</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevrons-up-down-icon lucide-chevrons-up-down text-muted-foreground opacity-50 shrink-0">
                  <path d="m7 15 5 5 5-5" /><path d="m7 9 5-5 5 5" />
                </svg>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.select button', function(e) {
        const popover = $(this).siblings('[data-popover], [data-custom-popover]');
    ...
    $(document).on('click', function() {
        $('[data-popover], [data-custom-popover]').attr('aria-hidden', 'true');
        $('.select button').attr('aria-expanded', 'false');
    });
});
